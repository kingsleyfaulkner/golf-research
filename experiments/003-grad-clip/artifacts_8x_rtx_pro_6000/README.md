...
| :--- | ---: | ---: | ---: | ---: | ---: | ---: |
| **Experiment** | 2.1749 | 1.2754 | 1.3444 | 1.2805 | 1.6938 | 1.5664 |
| **Baseline** | 2.1428 | 1.2764 | 1.3580 | 1.2806 | 1.8141 | 1.6003 |
| **Delta** | +0.0321 | -0.0009 | -0.0137 | -0.0001 | -0.1203 | -0.0339 |

## Quantization

| | int6 | int8 | mxfp4 | nvfp4 |
| :--- | ---: | ---: | ---: | ---: |
| **BPB** | 1.3444 | 1.2805 | 1.6938 | 1.5664 |
| **Size** | 11.6 MB | 15.7 MB | 8.6 MB | 9.2 MB |
