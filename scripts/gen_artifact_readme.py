...
def main():
    ...
    # For sweep variants, configs/README live in the parent experiment dir
    ...
    exp_readme = config_dir / "README.md"
    ...
    if experiment_name != "baseline" and config_dir.name != "baseline":
